...
* [Installer](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#installer)
* [Configurator](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#configurator)
* [Injector](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#injector)
* [Dispatcher](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#dispatcher)
* [Adapter](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#adapter)
* [Controller](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#controller)
* [Command Map](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#command-map)
...
[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-context)
...
[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-installer)
...
void Teardown();
```
[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-injector)
...
[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-dispatcher)
...
```
[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-adapter)

## Controller

[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-controller)
...
```
[Ejemplo](https://github.com/playgram/Software/blob/victor_develop/framework/README.md#ejemplo-reflector)
